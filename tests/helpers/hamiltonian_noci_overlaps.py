...
cisd_eqs = [
    ...
    [
        1.0,
        "jlia,bnkm,ij,ab,kl,mn->",
        ["iiie", "eiii", "ii", "ee", "ii", "ii", ""],
        ["H", "T", "A", "A", "A", "A", "X"],
    ],
    [
        1.0,
    ...
    [
        1.0,
        "jnia,lbkm,ij,kl,ab,mn->",
        ["iIiE", "iEiI", "ii", "ii", "EE", "II", ""],
        ["H", "T", "A", "A", "B", "B", "X"],
    ],
    [
        1.0,
    ...
    [
        1.0,
        "ljai,bnkm,ij,ab,kl,mn->",
        ["iIeI", "eiii", "II", "ee", "ii", "ii", ""],
        ["H", "T", "B", "A", "A", "A", "X"],
    ],
    [
        1.0,
    ...
    [
        0.25,
        "jlac,bdik,ab,cd,ij,kl->",
        ["iiee", "eeii", "ee", "ee", "ii", "ii", ""],
        ["H", "T", "A", "A", "A", "A", "X"],
    ],
    [
        1.0,
        "jlac,bdik,ab,ij,cd,kl->",
        ["iIeE", "eEiI", "ee", "ii", "EE", "II", ""],
        ["H", "T", "A", "A", "B", "B", "X"],
    ],
    [
        0.25,
...
cisdt_eqs = [
    ...
    [
        0.16666666666666666,
        "jlnikm,po,ij,kl,mn,op->",
        ["iiiiii", "ii", "ii", "ii", "ii", "ii", ""],
        ["T", "H", "A", "A", "A", "A", "X"],
    ],
    [
        0.16666666666666666,
    ...
    [
        0.5,
        "ja,blnikm,ab,ij,kl,mn->",
        ["ie", "eiiiii", "ee", "ii", "ii", "ii", ""],
        ["H", "T", "A", "A", "A", "A", "X"],
    ],
    [
        1.0,
    ...
    [
        0.5,
        "na,jlbikm,ij,kl,ab,mn->",
        ["IE", "iiEiiI", "ii", "ii", "EE", "II", ""],
        ["H", "T", "A", "A", "B", "B", "X"],
    ],
    [
        1.0,
        "la,jbnikm,ij,ab,kl,mn->",
        ["IE", "iEIiII", "ii", "EE", "II", "II", ""],
        ["H", "T", "A", "B", "B", "B", "X"],
    ],
    [
        0.25,
    ...
    [
        0.08333333333333333,
        "jlnikm,proq,ij,kl,mn,op,qr->",
        ["iiiiii", "iiii", "ii", "ii", "ii", "ii", "ii", ""],
        ["T", "H", "A", "A", "A", "A", "A", "X"],
    ],
    [
        0.16666666666666666,
    ...
    [
        0.5,
        "jlia,bnpkmo,ij,ab,kl,mn,op->",
        ["iiie", "eiiiii", "ii", "ee", "ii", "ii", "ii", ""],
        ["H", "T", "A", "A", "A", "A", "A", "X"],
    ],
    [
        1.0,
    ...
    [
        0.5,
        "jpia,lnbkmo,ij,kl,mn,ab,op->",
        ["iIiE", "iiEiiI", "ii", "ii", "ii", "EE", "II", ""],
        ["H", "T", "A", "A", "A", "B", "B", "X"],
    ],
    [
        1.0,
        "jnia,lbpkmo,ij,kl,ab,mn,op->",
        ["iIiE", "iEIiII", "ii", "ii", "EE", "II", "II", ""],
        ["H", "T", "A", "A", "B", "B", "B", "X"],
    ],
    [
        0.5,
    ...
    [
        0.5,
        "ljai,bnpkmo,ij,ab,kl,mn,op->",
        ["iIeI", "eiiiii", "II", "ee", "ii", "ii", "ii", ""],
        ["H", "T", "B", "A", "A", "A", "A", "X"],
    ],
    [
        1.0,
    ...
    [
        0.25,
        "jlac,bdnikm,ab,cd,ij,kl,mn->",
        ["iiee", "eeiiii", "ee", "ee", "ii", "ii", "ii", ""],
        ["H", "T", "A", "A", "A", "A", "A", "X"],
    ],
    [
        0.25,
    ...
    [
        1.0,
        "jnac,bldikm,ab,ij,kl,cd,mn->",
        ["iIeE", "eiEiiI", "ee", "ii", "ii", "EE", "II", ""],
        ["H", "T", "A", "A", "A", "B", "B", "X"],
    ],
    [
        1.0,
        "jlac,bdnikm,ab,ij,cd,kl,mn->",
        ["iIeE", "eEIiII", "ee", "ii", "EE", "II", "II", ""],
        ["H", "T", "A", "A", "B", "B", "B", "X"],
    ],
    [
        0.25,
        "lnac,jbdikm,ij,ab,cd,kl,mn->",
        ["IIEE", "iEEiII", "ii", "EE", "EE", "II", "II", ""],
        ["H", "T", "A", "B", "B", "B", "B", "X"],
    ],
    [
        0.25,
...
cisdtq_eqs = [
    ...
    [
        0.041666666666666664,
        "jlnpikmo,rq,ij,kl,mn,op,qr->",
        ["iiiiiiii", "ii", "ii", "ii", "ii", "ii", "ii", ""],
        ["T", "H", "A", "A", "A", "A", "A", "X"],
    ],
    [
        0.041666666666666664,
    ...
    [
        0.16666666666666666,
        "ja,blnpikmo,ab,ij,kl,mn,op->",
        ["ie", "eiiiiiii", "ee", "ii", "ii", "ii", "ii", ""],
        ["H", "T", "A", "A", "A", "A", "A", "X"],
    ],
    [
        0.5,
    ...
    [
        0.16666666666666666,
        "pa,jlnbikmo,ij,kl,mn,ab,op->",
        ["IE", "iiiEiiiI", "ii", "ii", "ii", "EE", "II", ""],
        ["H", "T", "A", "A", "A", "B", "B", "X"],
    ],
    [
        0.5,
        "na,jlbpikmo,ij,kl,ab,mn,op->",
        ["IE", "iiEIiiII", "ii", "ii", "EE", "II", "II", ""],
        ["H", "T", "A", "A", "B", "B", "B", "X"],
    ],
    [
        0.25,
    ...
    [
        0.5,
        "la,jbnpikmo,ij,ab,kl,mn,op->",
        ["IE", "iEIIiIII", "ii", "EE", "II", "II", "II", ""],
        ["H", "T", "A", "B", "B", "B", "B", "X"],
    ],
    [
        0.25,
    ...
    [
        ...
        "jlnpikmo,rtqs,ij,kl,mn,op,qr,st->",
        ["iiiiiiii", "iiii", "ii", "ii", "ii", "ii", "ii", "ii", ""],
        ["T", "H", "A", "A", "A", "A", "A", "A", "X"],
    ],
    [
        0.041666666666666664,
    ...
    [
        0.16666666666666666,
        "jlia,bnprkmoq,ij,ab,kl,mn,op,qr->",
        ["iiie", "eiiiiiii", "ii", "ee", "ii", "ii", "ii", "ii", ""],
        ["H", "T", "A", "A", "A", "A", "A", "A", "X"],
    ],
    [
        0.5,
    ...
    [
        0.16666666666666666,
        "jria,lnpbkmoq,ij,kl,mn,op,ab,qr->",
        ["iIiE", "iiiEiiiI", "ii", "ii", "ii", "ii", "EE", "II", ""],
        ["H", "T", "A", "A", "A", "A", "B", "B", "X"],
    ],
    [
        0.5,
        "jpia,lnbrkmoq,ij,kl,mn,ab,op,qr->",
        ["iIiE", "iiEIiiII", "ii", "ii", "ii", "EE", "II", "II", ""],
        ["H", "T", "A", "A", "A", "B", "B", "B", "X"],
    ],
    [
        0.5,
        "jnia,lbprkmoq,ij,kl,ab,mn,op,qr->",
        ["iIiE", "iEIIiIII", "ii", "ii", "EE", "II", "II", "II", ""],
        ["H", "T", "A", "A", "B", "B", "B", "B", "X"],
    ],
    [
        0.16666666666666666,
    ...
    [
        0.16666666666666666,
        "ljai,bnprkmoq,ij,ab,kl,mn,op,qr->",
        ["iIeI", "eiiiiiii", "II", "ee", "ii", "ii", "ii", "ii", ""],
        ["H", "T", "B", "A", "A", "A", "A", "A", "X"],
    ],
    [
        0.5,
    ...
    [
        0.125,
        "jlac,bdnpikmo,ab,cd,ij,kl,mn,op->",
        ["iiee", "eeiiiiii", "ee", "ee", "ii", "ii", "ii", "ii", ""],
        ["H", "T", "A", "A", "A", "A", "A", "A", "X"],
    ],
    [
        0.25,
    ...
    [
        0.5,
        "jpac,blndikmo,ab,ij,kl,mn,cd,op->",
        ["iIeE", "eiiEiiiI", "ee", "ii", "ii", "ii", "EE", "II", ""],
        ["H", "T", "A", "A", "A", "A", "B", "B", "X"],
    ],
    [
        1.0,
        "jnac,bldpikmo,ab,ij,kl,cd,mn,op->",
        ["iIeE", "eiEIiiII", "ee", "ii", "ii", "EE", "II", "II", ""],
        ["H", "T", "A", "A", "A", "B", "B", "B", "X"],
    ],
    [
        0.5,
        "jlac,bdnpikmo,ab,ij,cd,kl,mn,op->",
        ["iIeE", "eEIIiIII", "ee", "ii", "EE", "II", "II", "II", ""],
        ["H", "T", "A", "A", "B", "B", "B", "B", "X"],
    ],
    [
        0.125,
        "npac,jlbdikmo,ij,kl,ab,cd,mn,op->",
        ["IIEE", "iiEEiiII", "ii", "ii", "EE", "EE", "II", "II", ""],
        ["H", "T", "A", "A", "B", "B", "B", "B", "X"],
    ],
    [
        0.25,
        "lnac,jbdpikmo,ij,ab,cd,kl,mn,op->",
        ["IIEE", "iEEIiIII", "ii", "EE", "EE", "II", "II", "II", ""],
        ["H", "T", "A", "B", "B", "B", "B", "B", "X"],
    ],
    [
        0.125,
...
def ut_ao2mo(mf):
    ...
    if ncore != 0:
        ...
        ecore0 = np.einsum(
            "ij,ji->", core_dmao[0], hcore_ao + 0.5 * hveff_ao[0], optimize="optimal"
        )
        ecore0 += np.einsum(
            "ij,ji->", core_dmao[1], hcore_ao + 0.5 * hveff_ao[1], optimize="optimal"
        )
    else:
        ecore0 = 0.0
