...
def _ccpy_t_to_c_amplitudes(driver: Any, order: int, order_cc: int) -> "dict":
    ...
    # T4: ccpy stores (vir, vir, vir, vir, occ, occ, occ, occ) — transpose to iajbkcld
    # C4 uses raw t3 (not symmetrized ci3) — matches the original ccpy_interface.py
    if order_cc >= 4:
...
def _stage_ucisdt_input_from_ccpy(driver: Any, staged_mf: "StagedMf", order_cc: int) -> TrialInput:
